...
start = '      div[data-testid="stForm"] input {{\n'
end = '      @media (max-width:480px) {{\n'
i = s.find(start)
j = s.find(end, i)
if i < 0 or j < 0 or s.find(start, j + 1) >= 0:
    raise SystemExit('Bloco CSS esperado nao encontrado de forma unica; nenhuma alteracao aplicada.')

new = '''      div[data-testid="stForm"] [data-testid="stTextInput"] {{ width:100% !important; margin-bottom:9px !important; }}

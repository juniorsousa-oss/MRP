...
def _require_login(login_cfg):
    ...
    <style>
      ...
      div[data-testid="stForm"] {{
        position:fixed !important; left:50% !important; top:calc(50% + 4px - 5cm) !important; transform:translateX(-50%) !important;
      ...
      div[data-testid="stForm"] button {{
        ...
        height:29px !important; min-height:29px !important; margin-top:2px !important; border-radius:7px !important;
